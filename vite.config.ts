...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Kapka pro ušáčka',
        short_name: 'Kapka pro ušáčka',
        description: 'Registr králičích dárců krve',
        theme_color: '#EBD4CB',
        background_color: '#EBD4CB',
        icons: [
          {
  ...
  define: {
    ...
    VAPID_KEY: JSON.stringify(process.env.VITE_VAPID_KEY)
  },
  resolve: {
    alias: {
