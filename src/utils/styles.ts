...
export const playerBordersHover = {
  orange: 'hover:border-pcorange-900',
  green: 'hover:border-pcgreen-900',
  blue: 'hover:border-pcblue-900',
  pink: 'hover:border-pcpink-900'
}
export const playerInputOutlines = {
  orange:
